...
import {addPackThunk, deletePackThunk, getPacksThunk, setPage, setPageSize} from "../../store/packsTable/actions";
...
const PacksTable = () => {
    ...
    const columns = [
        ...
        },
        {
            title: 'Actions',
            width: '20%',
            render: (data: PackType, _: any) => (<ActionsColumn onLearn={() => {
                navigate(`/packs/${data._id}/cards`)
            }} onDeletePack={handleDelete} packId={data._id}/>)
        },
    ]
